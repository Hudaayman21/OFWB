...
public class Excel extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
         java.awt.EventQueue.invokeLater(() -> new Excel().setVisible(true));
    ...
    static class Model {
        ...
        public void addRow(Object[] rowData) {
            rows.add(rowData); // Add row data to the list
        }
        
        public List<Object[]> getRows() {
            return rows; // Provide access to rows if needed
        }
    ...
    private static class List<T> {
        ...
        private void add(Object[] rowData) {
